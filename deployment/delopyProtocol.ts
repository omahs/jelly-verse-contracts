...
task(`deploy-protocol`, `Deploys the Jelly Swap Protocol`).setAction(
  async (taskArguments: TaskArguments, hre: HardhatRuntimeEnvironment) => {
    ...
    const nativeToJellyRatio = 0;
    const vault = "0xb16F35c0Ae2912430DAc15764477E179D9B9EbEa";
    const poolId = "0xd37b5b84caf44f5f446ea03c265e3fceb14ea6ec00020000000000000000002f";
    ...
    const ChestFactory: Chest__factory =
      await hre.ethers.getContractFactory("Chest");
    ...
    const AllocatorFactory: Allocator__factory =
      await hre.ethers.getContractFactory("Allocator");
